...
def test_misra_mutation(fn, patch, should_fail):
  with tempfile.TemporaryDirectory() as tmp:
    ...
    # run test
    # bash from PATH rather than the platform shell: cmd.exe runs neither the script nor a VAR=value prefix, and a bare
    # "bash" would reach the WSL launcher in System32 before the MSYS2 one
